...
@section('content')
    ...
    <div class="flex items-center">
        <a href="#" class="bg-emerald-600 hover:bg-emerald-700 px-2 py-1 rounded text-gray-100 transition duration-300 ease-in-out cursor-pointer">Add Category Item</a>
    </div>
