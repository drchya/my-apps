...
@section('content')
    @if (Auth::user()->id === 1)
        <div class="flex items-center gap-2">
            <a href="{{ route('mountain.create') }}" class="text-xs bg-emerald-600 hover:bg-emerald-700 px-2 py-1 rounded text-gray-100 transition duration-300 ease-in-out cursor-pointer">Add Mountain</a>
        </div>
    @endif
                ...
                >
                    ...
                    >
                        <div class="flex items-center justify-between">
                            <h2 class="text-xl font-semibold">Mountain Details</h2>
